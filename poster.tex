...
\begin{poster}{
  ...
  \headerbox{Heuritics}{name=heuristics,column=1,row=0}{
  ...
  \headerbox{Results}{name=results,span=2,column=1,below=heuristics}{

	\begin{minipage}{\linewidth}
	  \includegraphics[width=\linewidth]{delta} \\
	  \includegraphics[width=0.49\linewidth]{res_cgroups}
	  \includegraphics[width=0.49\linewidth]{res_balloon}
	\end{minipage}


  }

  \headerbox{Results}{name=results2,span=2,column=1,below=results,above=bottom}{
	\begin{minipage}{\linewidth}
	  \includegraphics[height=0.27\linewidth]{barplot_vms}
	\end{minipage}
  }
